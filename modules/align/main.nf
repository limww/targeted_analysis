process ALIGN_READS {
  ...
  script:
  """
  bwa-mem2.avx2 mem -t 20 -M -R '@RG\\tID:${samplename}\\tSM:${samplename}\\tPL:ILLUMINA' $params.ref_fa $forward $reverse | gatk SortSam -I /dev/stdin -O ${samplename}.${params.timestamp}.sorted.bam --SORT_ORDER coordinate --CREATE_INDEX true
