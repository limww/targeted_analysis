process BASE_RECALIBRATOR_WES{
  ...
  script:
  """
  gatk BaseRecalibrator -R $params.ref_fa -I $sortedbam --known-sites $known_snps_dbsnp --known-sites $known_indels -L $target_bed -O ${sortedbam.simpleName}.${params.timestamp}.recal_data.table
